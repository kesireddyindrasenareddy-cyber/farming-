...
const SoilAnalyzer: React.FC<SoilAnalyzerProps> = ({ onAnalyze, result, loading, error }) => {
    ...
    return (
        <div className="p-4 border border-gray-200 rounded-lg bg-gray-50/50">
            <h3 className="text-lg font-bold text-brand-dark flex items-center"><ScienceIcon /> <span className="ml-2">Soil Analyzer</span></h3>
            <p className="text-sm text-gray-500 mt-1 mb-4">Get soil health recommendations. (+25 PTS)</p>
            ...
            <div className="mt-4 min-h-[120px]">
                ...
                {result && (
                    <div className="p-3 rounded-lg bg-blue-50 border-l-4 border-blue-500">
                        <p className="font-bold text-md text-blue-800">Analysis Summary</p>
